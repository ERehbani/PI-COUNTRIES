...
Crear una Aplicación web donde se puedan encontrar diferentes tipos de países de cocina 🥗, utilizando una API externa (https://spoonacular.com/food-api). Y a partir de ella, poder entre otras cosas:
