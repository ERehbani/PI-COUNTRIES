...
const Paginado = () => {
    ...
    let currPageCountry = [...countriesState].splice(firstIndex, countriesPerPage)
    ...
    return (
        <div className={styles.paginado}>
            <div className={styles.paginadoContainer}>
                <button onClick={() => prevHandler(currentPage)} className={styles.button}>PREV</button>
                    <p className={styles.pagina}>{currentPage}/{Math.floor(totCountries / countriesPerPage) + 1}</p>
                <button onClick={() => nextHandler(currentPage)} className={styles.button}>NEXT</button>
            </div>
        </div>
    )
}
